...
class NCF(pl.LightningModule):
    ...
    def train_dataloader(self):
        return DataLoader(MovieLensTrainDataset(self.ratings, self.all_movieIds),
                          batch_size=512, num_workers=5, persistent_workers=True)
...
if __name__ == "__main__":
    ...
    #TODO Убрать это, оно существует только до окончания разработки и для ускорения тестов
    # TAKE 30% HERE
    ...
    train_ratings, test_ratings = train_test_split(ratings, explicit=True)
    ...
    checkpoint_callback = ModelCheckpoint(dirpath=r'srс/weights/',
