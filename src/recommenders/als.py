...
class ALSRecommender(BaseRecommender):
    ...
    def get_recommendation(self, userid, N=10, filter_already_liked_items=True, filter_items=None, recalculate_user=False, items=None) -> tuple:
        '''
        Parameters
...
if __name__ == "__main__":
    ...
    with open(r'custom_user_ratings\egor_ratings.json', 'r', encoding='utf-8') as file:
        ...
        new_ratings = {int(movieid):float(rating) for movieid, rating in new_ratings.items()}
